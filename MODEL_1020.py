...
xx_submit = []
valid_f1 = []
LGBM_classify = lgb.LGBMClassifier(boosting_type='gbdt', objective='huber', num_leaves=110, max_depth=7,
                                   learning_rate=0.02, subsample_freq=5, n_estimators=5000, silent=True)
...
for k, (train_loc, test_loc) in enumerate(skf.split(X_val_data_, y_val_data_)):
    ...
    LGBM_classify.fit(X_train_combine, Y_train_combine,
                      ...
                      early_stopping_rounds=500, eval_sample_weight=None, eval_metric=lgb_f1_score_sk)
